...
import { Course, MOCK_COURSES, SubCourse } from '../../types/CourseTypes';
...
const YourPlan = () => {
  ...
  return (
    ...
    >
      <div className="absolute w-[500px] h-[300px] top-0 left-1/2 -translate-x-1/2 bg-gradient-to-r from-teal-400 to-blue-500 opacity-30 blur-3xl rounded-full"></div>
      
      <div className="relative z-10 flex justify-between items-center mb-6">
        <h1 className="text-2xl font-bold">Your Learning Journey</h1>
        <div className="flex gap-2 bg-white dark:bg-neutral-900 bg-opacity-60 dark:bg-opacity-60 p-1 rounded-lg backdrop-blur-md">
        ...
        {courses.map(course => (
          <SwiperSlide key={course.id} className="max-w-sm">
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
              className="bg-white dark:bg-neutral-900 bg-opacity-60 dark:bg-opacity-60 rounded-xl p-6 backdrop-blur-md overflow-hidden group"
            >
